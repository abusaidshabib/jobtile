    ...
    <div className="relative">
      <nav className="bg-white px-5 grid md:grid-cols-2 grid-cols-3 h-16 items-center shadow-lg">
        ...
        <div className="flex gap-3 justify-end">
          ...
          <Link className="border-2 border-main-v1 py-2 px-4 font-bold text-sm text-white bg-main-v1 hidden md:block">
            Sign Up
          </Link>
      ...
      >
        <ul className="h-full bg-white p-5 min-w-[248px] shadow-lg shadow-main-v1 flex flex-col gap-5 text-lg font-medium">
          <li className="flex justify-center">
            <button className="p-3 shadow-lg rounded-full border" onClick={() => setMenuStatus(false)}>
              <AiOutlineClose />
            </button>
          </li>
          <li>

...
import { education } from "../../../../Json/resumeForm";
import { modifyEducation } from "../../../../utils/ModifyData";
import { useDispatch } from "react-redux";
import { setEducationData } from "../../../../app/features/resume/formSlice";
        ...
        <div className="flex justify-between items-center" key={field.id}>
          <div className="border-2 p-8 rounded-lg w-full">
            <div className="w-full flex justify-between items-center">
              <p className="text-2xl font-semibold">Education title</p>
              <IoIosArrowDown

...
import { experience } from "../../../../Json/resumeForm";
import { useDispatch } from "react-redux";
import { modifyExperience } from "../../../../utils/ModifyData";
import { setExperience } from "../../../../app/features/resume/formSlice";
...
const WorkingExperience = () => {
  ...
  const deleteSection = (id) => {
    ...
    setFormData((prevData) => {
      ...
      const updatedData = {};
      Object.keys(newData).forEach((key) => {
        const [fieldName, fieldId] = key.split("_");
        const newId = parseInt(fieldId, 10);
        if (newId > id) {
          updatedData[`${fieldName}_${newId - 1}`] = newData[key];
        } else {
